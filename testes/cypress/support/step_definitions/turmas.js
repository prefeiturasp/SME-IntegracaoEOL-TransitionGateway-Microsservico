...
//   expect(Cypress.env("API_KEY_HEADER")).to.exist;
//   expect(Cypress.env("CODIGO_TURMA")).to.exist;
//   expect(Cypress.env("CODIGOS_TURMAS")).to.exist;
// });
...
// Then("retorna o status 200", function () {
//   cy.get("@response").then((response) => { expect(response.status).to.eq(200); });
// });
// Then("retorna o status 204", function () {
//   cy.get("@response").then((response) => { expect(response.status).to.eq(204); });
// });
// Then("retorna o status 400", function () {
//   cy.get("@response").then((response) => { expect(response.status).to.eq(400); });
// });
// Then("retorna o status 404", function () {
//   cy.get("@response").then((response) => { expect(response.status).to.eq(404); });
// });
